<script setup lang="ts">
  ...
  import { CheckCircle2, Circle, FolderKanban, ListTodo, Users } from 'lucide-vue-next'
  ...
  // todo: extract selected project to common value
</script>

<template>
  <div class="space-y-4 max-w-2xl pt-12 mx-auto">
    <!-- Project Header -->
    <div class="space-y-2">
      <!-- Project Icon -->
